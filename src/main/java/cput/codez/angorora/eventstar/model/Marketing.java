...
public final class Marketing {
    ...
    String providerContId;
    private String description;

    private Marketing() {
    }

    private Marketing(Builder build) {
         this.id=build.id;
    ...
    private String description;
        ...
        public Builder id(String id){
         ...
         public  Builder copier(Marketing market){
             this.id=market.id;
             this.providerContId=market.providerContId;
             this.eventId=market.eventId;
             this.providerName=market.providerName;
    ...
    public boolean equals(Object obj) {
        ...
        final Marketing other = (Marketing) obj;
